  ...
  const sidebarContent = (
    <>
      ...
      <div className="flex h-14 items-center gap-3 border-b border-border px-4">
        <div className="flex h-7 w-7 items-center justify-center rounded-md overflow-hidden bg-[hsl(220,15%,7%)] shadow-md">
    ...
    <div className="flex h-screen flex-col overflow-hidden bg-background">
      ...
      <header className="md:hidden flex h-12 shrink-0 items-center justify-between px-4 border-b border-border bg-ink-base z-10">
        ...
        <div className="flex items-center gap-2">
          <div className="flex h-6 w-6 items-center justify-center rounded-md overflow-hidden bg-[hsl(220,15%,7%)] shadow-md">
